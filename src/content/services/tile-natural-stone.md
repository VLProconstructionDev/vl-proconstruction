...
order: 2
features:
  - Porcelain, ceramic, marble, travertine, slate
  - Large-format and thin-slab installation
  - Substrate prep, uncoupling membranes, crack isolation
  - Sealed and finished natural stone
  - Custom patterns and cuts
included:
...
Tile is only as good as the substrate under it. We prep the floor, waterproof where needed, and set every tile with full mortar coverage so nothing cracks, rocks, or lifts later.
