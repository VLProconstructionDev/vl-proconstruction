...
order: 4
features:
  - Full demolition and subfloor assessment
  - Layout and plumbing-location planning
  - Shower, tub, and wet-room construction
  - Vanity, countertop, and mirror installation
...
faqs:
  ...
  - q: Can I use my bathroom during the remodel?
    a: Not the one we are working in. Most homes have a second bath, and we sequence the work so you are never without one. If yours is the only bathroom, tell us early and we will plan the schedule around it.
  - q: Do you move plumbing to change the layout?
    a: We do. Relocating a toilet, shifting a vanity to a double, or converting a tub alcove into a walk-in shower all mean new rough-in, and we coordinate the licensed plumber and the inspection as part of the job.
---

Bathroom remodeling is the whole room, not one surface. We handle demolition, layout, waterproofing, tile, vanity, and fixtures with a single in-house crew, so there is one schedule, one point of contact, and no gap between trades where problems hide.
